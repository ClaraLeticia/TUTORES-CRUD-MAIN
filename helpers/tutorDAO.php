...
class tutorDAO {
    ...
    function inserir_tutor($t_bean){
        ...
        $sql = "insert into TUTOR values ('".$t_bean->MATRICULA."','".$t_bean->EMAIL."','".$t_bean->SENHA."','".$t_bean->NOME."','".$t_bean->TELEFONE."','".$t_bean->MATERIA."')";
    ...
    $conexao = new PDO("mysql:dbname=talhorarios;localhost", "root", "");
        $upd = $conexao -> prepare("UPDATE tutor set NOME = '".$t_bean->NOME."', TELEFONE = '".$t_bean->TELEFONE."', EMAIL = '".$t_bean->EMAIL."', MATERIA = '".$t_bean->MATERIA."', SENHA = '".$t_bean->SENHA."' where MATRICULA_ALUNO = '".$t_bean->MATRICULA."';");
        $upd->execute();
